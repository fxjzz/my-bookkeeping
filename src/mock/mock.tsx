...
export const mockItemSummary: Mock = (config) => {
  ...
  if (group_by === 'happen_at' && kind === 'expenses') {
    return [
      ...
      {
        groups: [
          { happen_at: '2023-03-04T00:00:00.000+0800', amount: 100 },
    ...
    return [
      ...
      {
        groups: [
          { happen_at: '2023-03-02T00:00:00.000+0800', amount: 100 },
          { happen_at: '2023-03-25T00:00:00.000+0800', amount: 400 },
          { happen_at: '2023-03-29T00:00:00.000+0800', amount: 600 }
        ],
        summary: 600
      }
    ]
    ...
    return [
      ...
      {
        groups: [
          { tag_id: 1, tag: { id: 1, name: '交通', sign: faker.internet.emoji() }, amount: 500 },
